...
""",
    ...
    "resources_category": "Danh Mục:",
    "resources_software_installer": "Cài Đặt Phần Mềm",
    "resources_office_tools": "Office & Công Cụ",
    "resources_backup_tools": "Công Cụ Sao Lưu",
    "resources_description": "Mô Tả",
    "resources_actions": "Thao Tác",
    "btn_open_folder_location": "Mở Vị Trí",
    "btn_run_executable": "Chạy File",
    "btn_copy_to_desktop": "Copy Lên Desktop",
    "resources_software_installer_desc": "Công cụ cài đặt phần mềm tự động",
    "resources_office_tools_desc": "Microsoft Office, WinRAR, IDM và các công cụ khác",
    "resources_backup_tools_desc": "Công cụ sao lưu dữ liệu",
    "msg_run_executable": "Chạy file: {file}?",
    "msg_run_success": "Đã khởi chạy: {file}",
    "msg_copy_success": "Đã copy file lên Desktop!",
    "error_run_failed": "Lỗi khi chạy file: {error}",
    "error_copy_failed": "Lỗi khi copy file: {error}",
    "resources_file_info": "Thông Tin File",
    "resources_file_name": "Tên file:",
    "resources_file_size": "Dung lượng:",
    "resources_file_path": "Đường dẫn:",
