...
""",
    ...
    "resources_category": "Category:",
    "resources_software_installer": "Software Installer",
    "resources_office_tools": "Office & Tools",
    "resources_backup_tools": "Backup Tools",
    "resources_description": "Description",
    "resources_actions": "Actions",
    "btn_open_folder_location": "Open Location",
    "btn_run_executable": "Run File",
    "btn_copy_to_desktop": "Copy to Desktop",
    "resources_software_installer_desc": "Automatic software installation tool",
    "resources_office_tools_desc": "Microsoft Office, WinRAR, IDM and other tools",
    "resources_backup_tools_desc": "Data backup utility",
    "msg_run_executable": "Run file: {file}?",
    "msg_run_success": "Launched: {file}",
    "msg_copy_success": "File copied to Desktop!",
    "error_run_failed": "Error running file: {error}",
    "error_copy_failed": "Error copying file: {error}",
    "resources_file_info": "File Information",
    "resources_file_name": "File name:",
    "resources_file_size": "Size:",
